    ...
    <div className="mt-3 p-4 rounded-lg border border-amber-500/20 bg-amber-500/5 space-y-3">
      ...
      <div className="flex gap-2 pt-1">
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2 rounded bg-green-500/10 border border-green-500/25 text-green-400 text-sm hover:bg-green-500/15 disabled:opacity-50 transition-colors"
        >

          {isUploading ? <span className="inline-block w-3 h-3 border-2 border-green-400 border-t-transparent rounded-full animate-spin"></span>}
        </button>
      </div>
    </div>
  );
